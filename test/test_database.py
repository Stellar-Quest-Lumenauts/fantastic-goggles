...
class DatabaseTest(TestCase):
    ...
    def test_history(self):
        res = updateHistory(self.conn, "1234", "4567", "3501", "7890", "0", "0")
        self.assertTrue(res)
    ...
    def test_leaderboard(self):
        updateHistory(self.conn, "1234", "4567", "3501", "7890", "0", "0")
        updateHistory(self.conn, "1234", "3456", "3501", "7890", "0", "0")
        updateHistory(self.conn, "2233", "4568", "3501", "7890", "0", "0")
