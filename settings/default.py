...
REQUIRED_ROLE_IDS = env.json("REQUIRED_ROLE_ID", "[]")
...
MESSAGE_REPLY_POINTS = env.int("MESSAGE_REPLY_POINTS", 2)
REACTION_POINTS = env.int("MESSAGE_REACTION_POINTS", 1)
POSTED_MESSAGE_POINTS = env.int("MESSAGE_POSTED_POINTS", 1)
